export function generateTasks(profile) {
  ...
  tasks.push(
    ...
    { titre: 'Ouvrir un compte bancaire', categorie: 'banque', priorite: 'urgent', jour_cible: 2, phase: 1, description: "TD, RBC, Scotiabank, BMO, CIBC et Desjardins ont des programmes Newcomers sans historique de crédit. Compare les options dans la section Outils.", lien_officiel: 'https://www.canada.ca/fr/agence-consommation-matiere-financiere/sujets/produits-services-bancaires/comptes-bancaires/comptes-bancaires-nouveaux-arrivants.html' },
